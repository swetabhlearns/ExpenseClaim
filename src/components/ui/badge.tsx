    ...
    "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
    {
        variants: {
            variant: {
                ...
                rejected: "border-transparent bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300",
                disbursed: "border-transparent bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300",
            },
        },
        defaultVariants: {
            variant: "default",
