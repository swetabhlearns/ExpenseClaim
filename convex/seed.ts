...
export const seedData = mutation({
    ...
    handler: async (ctx) => {
        ...
        const userL1 = await ctx.db.insert("users", {
            name: "Priya Patel",
            email: "priya.patel@company.com",
            role: "L1_ADMIN",
        });

        const userL2 = await ctx.db.insert("users", {
            name: "Amit Kumar",
            email: "amit.kumar@company.com",
            role: "L2_ADMIN",
        });

        const userL3 = await ctx.db.insert("users", {
            name: "Sneha Reddy",
            email: "sneha.reddy@company.com",
            role: "L3_ADMIN",
        });

        const userL4 = await ctx.db.insert("users", {
            name: "Vikram Singh",
